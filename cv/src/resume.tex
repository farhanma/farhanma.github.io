...
{
\textbf{King Abdullah University of Science and Technology (KAUST)} \hfill 2014-2019
...
\textbf{King Abdullah University of Science and Technology (KAUST)} \hfill 2012-2013
...
{
\textbf{Postdoctoral Researcher, KAUST} \hfill 2020-Present
\begin{itemize}
\item
 (with David E. Keyes)\\
\end{itemize}

\textbf{Consultant, University of Tennessee, Knoxville} \hfill 2020-Present
\begin{itemize}
\item
Conttributing to the development of SLATE (\href{https://icl.utk.edu/slate/}{https://icl.utk.edu/slate/}) math library\\
\end{itemize}
...
%% \href{}
%% {Towards Optimal Memory Consistency Model for Distributed, GPU-Accelerated
...
\href{https://journals.sagepub.com/doi/10.1177/1094342020938421}
{MAGMA Templates for Scalable Linear Algebra on Emerging
Architectures}, \textit{IJHPCA 2020}

\url{https://bitbucket.org/icl/magmat}
\item
...
\begin{itemize}
\item
M. Gates, A. Charara, J. Kurzak, A. YarKhan, \textbf{M. Al Farhan}, D. Sukkari, and J. Dongarra.
